...
<div class="breadcrumb-section">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="ap-title">
                            <h2><?php
                            include("connect.php");
                                $result = mysqli_query($conn, "SELECT * FROM about_us WHERE type=3");
    ...
    <!-- Video Section Begin -->
    <section class="video-section set-bg" data-setbg="img/about/video-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-text">
                        ...
                        <a href="https://www.youtube.com/watch?v=H1CIBqDeWQ0" class="play-btn video-popup"><img
