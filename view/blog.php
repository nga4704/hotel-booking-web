        ...
        <div class="container">
            <div class="row">
                ...
                if (isset($_GET['id'])) {
                    ...
                    $total = $row2['total'];
                    $result = mysqli_query($conn, "SELECT * FROM blog WHERE status=1  ORDER BY id DESC LIMIT 9,$total");
                } else {
                    $result = mysqli_query($conn, "SELECT * FROM blog WHERE status=1  ORDER BY id DESC LIMIT 9");
                }
