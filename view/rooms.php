    ...
    <section class="rooms-section spad">
        <div class="container">
            <div class="row">
                ...
                $kq = mysqli_query($conn, 'SELECT count(id) AS tongSoPhong FROM room');
                ...
                $kq2 = mysqli_query($conn, "SELECT * FROM room ORDER BY id DESC LIMIT $soBatDau, $soLuongPhongMoiTrang");
                ...
                <div class="col-lg-12">
                    <div class="room-pagination">
                        ...
                        if ($trangHienTai > 1 && $tongSoTrang > 1) {
                            echo '<a href="rooms.php?p=' . ($trangHienTai - 1) . '" class="prev-arrow"><i class="fa fa-long-arrow-lem²" aria-hidden="true"></i>   Prev</a>';
                        }
                        // Lặp khoảng giữa
