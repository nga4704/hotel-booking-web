...
<head>
  ...
  <link rel="stylesheet" href="css/vertical-layout-light/new-style.css">
...
<body>
  ...
  if (isset($_SESSION['dn']) && ($_SESSION['dn'] === true)) {
    if (isset($_SESSION['idAdmin'])) {
      ...
      $result = mysqli_query($conn, "SELECT * FROM admin WHERE id=" . $idUser);
  ...
  <header>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="border-bottom: 5px solid #282f3a;">
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="../uploads/admin/<?php if (!empty($row['img'])) {
                                        echo $row['img'];
                                      } else {
                                        echo 'user.png';
                                      } ?>" alt="profile" />
              <span class="nav-profile-name"><?php echo $row['username'] ?></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <a class="dropdown-item" href="index.php?login=0">
