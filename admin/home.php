        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-xl-12 grid-margin stretch-card flex-column">
              <h5 class="mb-2 text-titlecase mb-4" style="margin: 15px 0 -20px 0; ">Thống Kê</h5>
              <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <p class="mb-0 text-muted"><a href="hosodatphong.php">Số Giao Dịch</a></p>
                        <p class="mb-0 text-muted"></p>
                      </div>
                      <h4><?php
                          $result = mysqli_query($conn, "SELECT count(id) AS totalGiaoDich FROM booking WHERE status=4 OR status=5");
                          $row = mysqli_fetch_assoc($result);
                          echo $row['totalGiaoDich'];
                          ?></h4>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                          <p class="mb-2 text-muted"><a href="hosodatphong.php">Số Phòng Đang Đặt</a></p>
                          <h6 class="mb-0"><?php
                          $result = mysqli_query($conn, "SELECT count(id) AS total FROM booking WHERE status=3");
                          $row = mysqli_fetch_assoc($result);
                          echo $row['total'];
                          ?> phòng</h6>
                        </div>
                        <div>
                          <p class="mb-2 text-muted"><a href="hosodatphong.php">Số Phòng Đang Trống</a></p>
                          <h6 class="mb-0"><?php
                          $result = mysqli_query($conn, "SELECT count(id) AS total FROM room");
                          $result2 = mysqli_query($conn, "SELECT count(id) AS totalDaDat FROM booking WHERE status=3");
                          $row = mysqli_fetch_assoc($result);
                          $row2 = mysqli_fetch_assoc($result2);
                          $phongTrong = $row['total'] - $row2['totalDaDat'];
                          echo $phongTrong;
                          ?> phòng</h6>
                        </div>
                        <div>
                          <p class="mb-2 text-muted"><a href="room.php">Tổng Số Phòng</a></p>
                          <h6 class="mb-0"><?php
                          $result = mysqli_query($conn, "SELECT count(id) AS total FROM room");
                          $row = mysqli_fetch_assoc($result);
                          echo $row['total'];
              ...
              <div class="row h-100">
                <!-- <div class="col-md-6 stretch-card grid-margin grid-margin-md-0">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                      <p class="text-muted">Số Lượt Đánh Giá</p>
                      <div class="d-flex justify-content-between align-items-center mb-2">
                        <h3 class="mb-"><?php
                                        $result2 = mysqli_query($conn, "SELECT count(id) AS totalDanhGia FROM review");
                                        $row2 = mysqli_fetch_assoc($result2);
                                        echo $row2['totalDanhGia'];
                                        ?></h3>
                        <h3 class="mb-">78%</h3>
                      </div>
                      <canvas id="sales-chart-b" class="mt-auto" height="50"></canvas>
                    </div>
                  </div>
                </div> -->
                    ...
                    <div class="card-body">
                      <div class="row h-100">
                        <div class="col-6 d-flex flex-column justify-content-between">
                          <p class="text-muted"><a href="review.php">Số Lượt Đánh Giá</a></p>
                          <h4><?php
                              $result2 = mysqli_query($conn, "SELECT count(id) AS totalDanhGia FROM review");
                              $row2 = mysqli_fetch_assoc($result2);
                              echo $row2['totalDanhGia'];
                        ...
                        <div class="col-6 d-flex flex-column justify-content-between">
                          <p class="text-muted"><a href="phanhoi.php">Phản Hồi & Góp Ý</a></p>
                          <h4><?php
                              $result2 = mysqli_query($conn, "SELECT count(id) AS total FROM phanhoi");
                              $row2 = mysqli_fetch_assoc($result2);
                              echo $row2['total'];
                              ?></h4>
                ...
                <div class="col-md-6 stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <div class="row h-100">
                        <div class="col-6 d-flex flex-column justify-content-between">
                          <p class="text-muted"><a href="hosodatphong.php">Phòng Bị Hủy</a></p>
                          <h4><?php
                          $result = mysqli_query($conn, "SELECT count(id) AS total FROM booking WHERE status=2");
                          $row = mysqli_fetch_assoc($result);
                          echo $row['total'];
                          ?> phòng</h4>
                          <!-- <canvas id="cpu-chart" class="mt-auto"></canvas> -->
                        ...
                        <div class="col-6 d-flex flex-column justify-content-between">
                          <p class="text-muted"><a href="new-booking.php">Khách Hàng Mới Đặt</a></p>
                          <h4><?php
                          $result = mysqli_query($conn, "SELECT count(id) AS total FROM booking WHERE status=1");
                          $row = mysqli_fetch_assoc($result);
                          echo $row['total'];
                          ?> phòng</h4>
                          <!-- <canvas id="memory-chart" class="mt-auto"></canvas> -->
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4">
                    <div>
                      <p class="mb-2 text-md-center text-lg-left"><a href="customer.php">Khách Hàng Đăng Ký</a></p>
                      <h1 class="mb-0"><?php
                              $result3 = mysqli_query($conn, "SELECT count(id) AS totalUser FROM user");
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4">
                    <div>
                      <p class="mb-2 text-md-center text-lg-left"><a href="#">Tổng Số Loại Phòng</a></p>
                      <h1 class="mb-0"><?php
                              $result4 = mysqli_query($conn, "SELECT count(id) AS totalCategoryRoom FROM category_room");
                              $row4 = mysqli_fetch_assoc($result4);
                              echo $row4['totalCategoryRoom'];
                              ?></h1>
                    </div>
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4">
                    <div>
                      ...
                      <h1 class="mb-0">$<?php
                              $result5 = mysqli_query($conn, "SELECT SUM(thanhToan) AS total FROM booking;");
